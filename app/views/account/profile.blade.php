...
<aside>
  <div id="sidebar" class="nav-collapse ">
      ...
      <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered">
              {{HTML::image('assets/img/georgia.jpg', 'user photo', array('class' => 'img-rounded', 'width' => '180', 'height' => '180'))}}
          <h4 class="centered">Georgia O'Keeffe</h4>

          <div class="aboutMe">
            <p class="about"> Georgia O'Keeffe was born on November 15, 1887, in Sun Prairie, Wisconsin and studied at the Art Institute of Chicago.
            </p>
            
            <button type="submit" class="btn btn-primary btn-md"> Follow </button>
          </div>
          <!-- /aboutMe -->
